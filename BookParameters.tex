...
%% ----------------------------------------------------------------------------
% If a price is defined then the makecover script will create a barcode with
% the GhostScript barcode.ps barcode generator: see Terry Burton's PostScript
% based barcode generator. See: https://github.com/bwipp/postscriptbarcode.
